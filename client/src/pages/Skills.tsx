  ...
  const skillCategories = [
    {
      ...
      color: "hsl(160, 84%, 39%)",
      skills: [
        { name: "React.js", level: 95, experience: "1+ year" },
        { name: "TypeScript", level: 90, experience: "1+ year" },
        { name: "JavaScript (ES6+)", level: 95, experience: "1+ year" },
        { name: "HTML5 & CSS3", level: 95, experience: "1+ year" },
    ...
    },
    {
      ...
      color: "hsl(221, 83%, 53%)",
      skills: [
        { name: "Node.js", level: 90, experience: "1+ year" },
        { name: "Express.js", level: 90, experience: "1+ year" },
        { name: "Python", level: 80, experience: "1+ year" },
        { name: "Flask", level: 75, experience: "1+ year" },
        { name: "REST APIs", level: 95, experience: "1+ year" },
    ...
    },
    {
      ...
      color: "hsl(142, 71%, 45%)",
      skills: [
        { name: "MongoDB", level: 90, experience: "1+ year" },
        { name: "MySQL", level: 80, experience: "1+ year" },
    ...
    },
    {
      ...
      color: "hsl(24, 95%, 53%)",
      skills: [
        { name: "Git & GitHub", level: 95, experience: "1+ year" },
        { name: "Docker", level: 75, experience: "1+ year" },
        { name: "Postman", level: 90, experience: "1+ year" },
        { name: "VS Code", level: 95, experience: "1+ year" },
        { name: "Vercel/Render", level: 85, experience: "1+ year" },
      ],
    },
    {
      icon: Zap,
      ...
      skills: [
        ...
        { name: "JWT Authentication", level: 90, experience: "1+ year" },
        ...
        { name: "Bootstrap", level: 85, experience: "1+ year" },
