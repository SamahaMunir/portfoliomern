    ...
    <div className="container mx-auto px-4 py-20">
      ...
      >
        ...
        <p className="text-lg mb-12">
          I build modern web applications with React, Node.js, MongoDB, and Express.
      ...
      >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto">
          {["React", "Node.js", "MongoDB", "Express", "TypeScript", "Tailwind CSS", "Git", "REST APIs"].map((skill) => (
            <div key={skill} className="p-4 border border-border rounded-lg text-center hover:border-primary transition">
              {skill}
            </div>
          ))}
        </div>
